-- Display all shows from the hbtn_0d_tvshows database that have at least one linked genre 
-- Retrieve all rows in a database that share one column in common
